...
public class SpiralAgentManager : MonoBehaviour
{
    public int agentCount = 10;
    public float agentSpawnRadius = 20;
    public GameObject agentPrefab;
    public static Dictionary<GameObject, SpiralAgent> agentsObjs = new Dictionary<GameObject, SpiralAgent>();

    private static List<SpiralAgent> agents = new List<SpiralAgent>();
    ...
    {
        var agent = obj.GetComponent<SpiralAgent>();
