...
public class GroupFollowerAgentManager : MonoBehaviour
{
    public int agentCount = 10;
    public float agentSpawnRadius = 20;
    public GameObject agentPrefab;
    public static Dictionary<GameObject, GroupFollowerAgent> agentsObjs = new Dictionary<GameObject, GroupFollowerAgent>();

    private static List<GroupFollowerAgent> agents = new List<GroupFollowerAgent>();
    ...
    {
        var agent = obj.GetComponent<GroupFollowerAgent>();
